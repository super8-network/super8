...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 S8 from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 S8 in block rewards plus fees, but
        ...
        # Send 100 S8 with subtract fee from amount
        ...
        # Sendmany 100 S8 with subtract fee from amount
