...
This mechanism has been integrated into Bitcore-Node-Super8 which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/super8pay/insight-api-super8#web-socket-api](https://github.com/super8pay/insight-api-super8#web-socket-api)
* API: [https://github.com/super8pay/insight-api-super8#instantsend-transactions](https://github.com/super8pay/insight-api-super8#instantsend-transactions)
...
By default, the Super8 Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Super8 Core daemon:
