...
This document provides guidelines for internationalization of the Super8 Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `super8_en.ts` remains unchanged.
