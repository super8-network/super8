    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  super8-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Super8 in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 S8, 0.1 S8, 1 S8 and 10 S8 -- sort of like the paper money you use every day.</li> \
