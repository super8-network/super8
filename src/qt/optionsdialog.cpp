    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("S8-light"), QVariant("light"));
    ui->theme->addItem(QString("S8-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("S8-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("S8-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("S8-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("S8-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("S8-traditional"), QVariant("trad"));
