...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Super8 address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "super8",               "masternode",             &masternode,             true,  {} },
    { "super8",               "masternodelist",         &masternodelist,         true,  {} },
    { "super8",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "super8",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "super8",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "super8",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
