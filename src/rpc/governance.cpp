...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in super8.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("super8.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Super8 features */
    { "super8",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "super8",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "super8",               "gobject",                &gobject,                true,  {} },
    { "super8",               "voteraw",                &voteraw,                true,  {} },
