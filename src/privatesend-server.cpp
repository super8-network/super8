...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Super8 related functionality
...
/*
    ...
    allow endless transaction that would bloat Super8 and make it unusable. To
