...
public:
    ...
    CAmount GetDustThreshold(const CFeeRate &minRelayTxFee) const
    {
        ...
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 1000 Bit per kB
        // and that means that fee per spendable txout is 182 * 1000 / 1000 = 182 Bit.
        // So dust is a spendable txout less than 546 * minRelayTxFee / 1000 (in Bit)
        // i.e. 182 * 3 = 546 Bit with default -minrelaytxfee = minRelayTxFee = 1000 Bit per kB.
