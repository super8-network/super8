...
official/supported Docker Images found at https://hub.docker.com/r/super8pay/super8d/
...
**NOTE: Please update the image description at https://hub.docker.com/r/super8pay/super8d-develop/ when changing the above text**